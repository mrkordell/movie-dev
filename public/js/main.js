...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "C:\\Users\\tony\\Sites\\movie-dev\\resources\\assets\\js\\components\\search.vue"
  if (!module.hot.data) {
...
exports.default = {
  ...
  route: {
    data: function data(transition) {
      $.get('/user/movies', function (data) {
        return transition.next({ movies: data });
      }, 'json');
    }
  },
  methods: {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\tony\\Sites\\movie-dev\\resources\\assets\\js\\components\\tracked.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\tony\\Sites\\movie-dev\\resources\\assets\\js\\components\\upcoming.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
var _tracked = require('./components/tracked.vue');
...
var _upcoming = require('./components/upcoming.vue');
...
router.map({
    ...
    '/upcoming': {
        component: _upcoming2.default
    },
    '/tracked': {
        component: _tracked2.default
    }
});
...
},{"./components/search.vue":4,"./components/tracked.vue":5,"./components/upcoming.vue":6}]},{},[7]);
